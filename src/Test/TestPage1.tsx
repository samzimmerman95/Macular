    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.instructions}>
          Hold your device in a normal reading position. It is important you
          keep your phone in the same place to ensure consistent results. You
          will test one eye at a time, first we will test the left eye.
        </Text>
        <Text></Text>
